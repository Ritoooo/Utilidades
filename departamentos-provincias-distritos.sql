...
CREATE TABLE `distritos` (
  ...
  `provincia_id` int(5) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_distritos_1_idx` (`provincia_id`),
  CONSTRAINT `fk_distritos_1` FOREIGN KEY (`provincia_id`) REFERENCES `provincias` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1811,'SAN JUAN DE LA VIRGENdistritos',187),
(1812,'ZORRITOS',188),
(1813,'CASITAS',188),
(1814,'ZARUMILLA',189),
...
CREATE TABLE `provincias` (
  ...
  `departamento_id` int(5) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_provincias_1_idx` (`departamento_id`),
  CONSTRAINT `fk_provincias_1` FOREIGN KEY (`departamento_id`) REFERENCES `departamentos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `provincias` */

insert  into `provincias`(`id`,`provincia`,`departamento_id`) values 
(1,'CHACHAPOYAS ',1),
(2,'BAGUA',1),
(3,'BONGARA',1),
(4,'CONDORCANQUI',1),
